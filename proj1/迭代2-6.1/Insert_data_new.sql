...
BEGIN
	...
	insert into appointment_finish VALUES (i,floor(RAND()*999900+1+100),random_time_slot_id,adate,floor(RAND()*100+1));
	ELSE
	select date(from_unixtime(
	...
	insert into appointment VALUES (i,floor(RAND()*999900+1+100),random_time_slot_id,adate,0,0);
	end if;
	set i = i+1;
	end while;
END;
